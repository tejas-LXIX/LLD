...
import lldquestions.splitwise.group.Group;
import lldquestions.splitwise.group.GroupController;
import lldquestions.splitwise.user.User;
import lldquestions.splitwise.user.UserController;
...
public class Splitwise {
    ...
    public void demo() throws Exception {
        ...
        Split split1 = new Split(userController.getUser("U1001"));
        Split split2 = new Split(userController.getUser("U2001"));
        Split split3 = new Split(userController.getUser("U3001"));
        splits.add(split1);
        splits.add(split2);
        splits.add(split3);
        ...
        Split splits2_1 = new Split(userController.getUser("U1001"));
        splits2_1.setAmount(400);
        Split splits2_2 = new Split(userController.getUser("U2001"));
        splits2_2.setAmount(100);
